...
-- ACCESS RIGHTS:
-- 1. ADMIN: 'admin'@'localhost' IDENTIFIED BY 'admin_password';  GRANT ALL PRIVILEGES ON McDonaldsDB has been given to Admin.
-- 2. MANAGER: 'manager'@'localhost' IDENTIFIED BY 'manager_ashok'; GRANT SELECT, INSERT, UPDATE ON McDonaldsDB.Store, McDonaldsDB.Employee, McDonaldsDB.Order, McDonaldsDB.OrderDetails has been given to Manager.
-- 3. STAFF: 'staff'@'localhost' IDENTIFIED BY 'staff_ashok'; GRANT SELECT, INSERT ON McDonaldsDB.Order, McDonaldsDB.OrderDetails has been given to Staff.
